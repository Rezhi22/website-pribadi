...
// Fade-in animation ketika scroll
document.addEventListener("scroll", function () {
    const elements = document.querySelectorAll(".history-card, .timeline-item");
...
// Trigger fade on load (sometimes top elements)
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* ========== COMMUNITY SLIDER (versi aman) ========== */
    const slides = document.querySelectorAll('.community-slide');
    const dots = document.querySelectorAll('.dot');
    const nextBtn = document.querySelector('.community-next');
    const prevBtn = document.querySelector('.community-prev');
    ...
    if (slides.length > 0) {
        ...
        // Cek jika tombolnya benar-benar ada
        if (nextBtn) {
